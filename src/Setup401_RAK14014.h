...
#define TFT_BL   WB_IO3            // LED back-light control pin
...
#define TFT_CS WB_SPI_CS // Chip select control pin D8
#define TFT_DC WB_IO4	 // Data Command control pin
#define TFT_RST WB_IO5	 // Reset pin (could connect to NodeMCU RST, see next line)
// #define TFT_RST  -1    // Set TFT_RST to -1 if the display RESET is connected to NodeMCU RST or 3.3V
#define TFT_MOSI WB_SPI_MOSI
#define TFT_MISO WB_SPI_MISO
#define TFT_SCLK WB_SPI_CLK

#define TFT_BL WB_IO3  // LED back-light (only for ST7789 with backlight control pin)
